...
constexpr unsigned char FONTARR[][12] = {
...
struct Font
{
    static constexpr size_t fontWidth=6;
    static constexpr size_t fontHeight=12;

    std::vector<unsigned char> operator[](char ch) const;
};
